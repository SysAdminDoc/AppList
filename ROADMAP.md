...
Windows tool that scans registry + WOW6432Node + HKCU + UWP + Program Files, exports installed app inventory to TXT/CSV. PyQt-style dark GUI with sortable columns, filtering, and context actions.

## Planned Features

### Scanners
- Add winget source — `winget list --source winget/msstore` merge pass
